...
class predict_pipeline:
    ...
    def predict(self, features):  # Correct indentation
        try:
            model_path = os.path.join("artifacts", "model_trainer.pkl")  # Fixed "artifcats" typo
            preprocessor_path = os.path.join("artifacts", "preprocessor.pkl")  # Fixed "artifcats" typo
